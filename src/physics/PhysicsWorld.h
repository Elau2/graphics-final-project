...
private:
    // Add gravity + clear accumulators for the next step.
    void integrateForces(float dt);
    // Collide with the ground plane and resolve impulses (multi-contact).
    void collideGround();
    // Pairwise body<->body collisions.
    void collideBodies();
    // Put slow-moving bodies to sleep; called at the end of step().
